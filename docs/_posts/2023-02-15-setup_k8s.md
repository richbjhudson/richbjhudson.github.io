...
# Steps
## [anchor](#Prerequisites to Setup Kubernetes Cluster - Applies to all VMs) 
...
- Check that all [Prerequisites to Setup Kubernetes Cluster](/_posts/2023-02-15-setup_k8s#Prerequisites to Setup Kubernetes Cluster - Applies to all VMs) are in place.
